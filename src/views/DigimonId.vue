...
<template>
  ...
  >
    ...
    <div class="col-start-1 row-start-2 px-5 md:pl-5 md:pr-0 lg:pl-10 lg:pr-0">
      <h2
        class="mt-10 pb-2 mb-5 text-xl font-bold text-left md:text-2xl md:my-8 border-b-2 md:mb-5 lg:text-3xl lg:my-8 lg:mb-6"
      >
        Description
      </h2>
    ...
    <div class="col-start-1 col-span-2 row-start-3 px-5 sm:px-5 lg:px-10">
      <h2
        class="mt-10 mb-5 pb-3 text-xl font-bold text-left md:text-2xl border-b-2 md:mb-5 lg:text-3xl lg:my-10 lg:mb-6"
      >
        Skills
      </h2>
      <ul class="grid gap-3 md:text-lg lg:text-xl">
        <li
          class="items-center pl-0 sm:pl-5"
          v-for="item in dataDigimon().digimonId.skills"
          :key="item.id"
        >
          <p>
